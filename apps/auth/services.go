...
func (m Service) GetTokenFromHeader(c *gin.Context) (string, error) {
...
func (m Service) ParseAndVerifyToken(tokenString, secret string) (*jwt.Token, error) {
...
func (m Service) RetrieveClaims(token *jwt.Token) (*JWTClaims, error) {
	// Verfify token
...
func (m Service) GenerateToken(claims JWTClaims, secret string) (string, error) {
