...
func (c {{ucresource}}Repository) WithTrx(trxHandle *gorm.DB) {{ucresource}}Repository {
	if trxHandle == nil {
...
// Save {{ucresource}}
func (c {{ucresource}}Repository) Save({{ucresource}} models.{{ucresource}}) (models.{{ucresource}}, error) {
